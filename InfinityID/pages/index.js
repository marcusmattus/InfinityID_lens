  ...
  return (
    <div className={styles.container}>
      <main className={styles.main}>
        <h1 className={styles.title}>Welcome to NFT Lens!</h1>
      
        
          <nav className={styles.nav} centered>
            

                  <Button className={styles.centered} onClick="Wallet" centered>Connect Wallet</Button>
